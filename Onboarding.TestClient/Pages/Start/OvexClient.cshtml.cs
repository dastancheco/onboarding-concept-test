...
{
    public class OvexClientModel : PageModel
    {
        private readonly IOnboardingApiClient _apiClient;
        private readonly ILogger<OvexClientModel> _logger;

        public OvexClientModel(IOnboardingApiClient apiClient, ILogger<OvexClientModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                _logger.LogInformation("Creating OVEX Client prospect for email: {Email}", Email);
                ...
                TempData["OnboardingType"] = "OVEX_CLIENT";
