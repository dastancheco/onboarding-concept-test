...
{
    public class OvexFleetModel : PageModel
    {
        private readonly IOnboardingApiClient _apiClient;
        private readonly ILogger<OvexFleetModel> _logger;

        public OvexFleetModel(IOnboardingApiClient apiClient, ILogger<OvexFleetModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                _logger.LogInformation("Creating OVEX Fleet prospect for email: {Email}", Email);
                ...
                TempData["OnboardingType"] = "OVEX_FLEET";
